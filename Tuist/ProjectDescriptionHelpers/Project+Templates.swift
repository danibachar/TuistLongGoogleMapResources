    ...
    private static func makeAppTargets(name: String, platform: Platform, dependencies: [TargetDependency]) -> [Target] {
        ...
        let mainTarget = Target(
            ...
            dependencies: dependencies + [
                ...
                .xcframework(path: "libs/Google/GoogleMaps/GoogleMaps-6.0.1-beta/GoogleMapsBase.xcframework"),
                .xcframework(path: "libs/Google/GoogleMaps/GoogleMaps-6.0.1-beta/GoogleMapsCore.xcframework"),
            ]
        )
